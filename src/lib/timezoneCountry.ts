 ...
 *
 * Used to default the phone-number input's country from the visitor's browser
 * time zone (`Intl.DateTimeFormat().resolvedOptions().timeZone`) — fully
 * client-side, so no IP is ever sent to a third party (GDPR-friendly).
 *
 * Derived from the IANA tz database (zone1970.tab). A handful of legacy/alias
 * zone names are kept alongside their canonical replacements (e.g. Europe/Kiev
 * and Europe/Kyiv) so older runtimes resolve too. Zones that span multiple
 * countries map to the primary one; anything not listed falls back to the
 * organizer's country (then 'MD') at the call site.
 */
export const TIMEZONE_COUNTRY: Record<string, string> = {
	...
	'America/Argentina/Ushuaia': 'AR', 'America/Aruba': 'AW', 'America/Asuncion': 'PY', 'America/Atikokan': 'CA',
	...
	'America/Fortaleza': 'BR', 'America/Glace_Bay': 'CA', 'America/Godthab': 'GL', 'America/Goose_Bay': 'CA',
	...
	'America/La_Paz': 'BO', 'America/Lima': 'PE', 'America/Los_Angeles': 'US', 'America/Lower_Princes': 'SX',
	'America/Maceio': 'BR', 'America/Managua': 'NI', 'America/Manaus': 'BR', 'America/Marigot': 'MF',
	'America/Martinique': 'MQ', 'America/Matamoros': 'MX', 'America/Mazatlan': 'MX', 'America/Menominee': 'US',
	'America/Merida': 'MX', 'America/Metlakatla': 'US', 'America/Mexico_City': 'MX', 'America/Miquelon': 'PM',
	'America/Moncton': 'CA', 'America/Monterrey': 'MX', 'America/Montevideo': 'UY', 'America/Montserrat': 'MS',
	'America/Nassau': 'BS', 'America/New_York': 'US', 'America/Nipigon': 'CA', 'America/Nome': 'US',
	'America/Noronha': 'BR', 'America/North_Dakota/Beulah': 'US', 'America/North_Dakota/Center': 'US',
	'America/North_Dakota/New_Salem': 'US', 'America/Nuuk': 'GL', 'America/Ojinaga': 'MX', 'America/Panama': 'PA',
	'America/Pangnirtung': 'CA', 'America/Paramaribo': 'SR', 'America/Phoenix': 'US', 'America/Port-au-Prince': 'HT',
	'America/Port_of_Spain': 'TT', 'America/Porto_Velho': 'BR', 'America/Puerto_Rico': 'PR', 'America/Punta_Arenas': 'CL',
	...
	'America/St_Thomas': 'VI', 'America/St_Vincent': 'VC', 'America/Swift_Current': 'CA', 'America/Tegucigalpa': 'HN',
	'America/Thule': 'GL', 'America/Thunder_Bay': 'CA', 'America/Tijuana': 'MX', 'America/Toronto': 'CA',
	...
	// Antarctica / Arctic
	'Antarctica/Casey': 'AQ', 'Antarctica/Davis': 'AQ', 'Antarctica/DumontDUrville': 'AQ', 'Antarctica/Macquarie': 'AU',
	'Antarctica/Mawson': 'AQ', 'Antarctica/McMurdo': 'AQ', 'Antarctica/Palmer': 'AQ', 'Antarctica/Rothera': 'AQ',
	'Antarctica/Syowa': 'AQ', 'Antarctica/Troll': 'AQ', 'Antarctica/Vostok': 'AQ', 'Arctic/Longyearbyen': 'SJ',
	...
	'Asia/Pontianak': 'ID', 'Asia/Pyongyang': 'KP', 'Asia/Qatar': 'QA', 'Asia/Qostanay': 'KZ', 'Asia/Qyzylorda': 'KZ',
	'Asia/Riyadh': 'SA', 'Asia/Sakhalin': 'RU', 'Asia/Samarkand': 'UZ', 'Asia/Seoul': 'KR', 'Asia/Shanghai': 'CN',
	...
	// Australia
	'Australia/Adelaide': 'AU', 'Australia/Brisbane': 'AU', 'Australia/Broken_Hill': 'AU', 'Australia/Darwin': 'AU',
...
/** Map an IANA time-zone id to an ISO 3166-1 alpha-2 country code, or null if unknown. */
export function getCountryFromTimezone(timeZone: string | undefined | null): string | null {
